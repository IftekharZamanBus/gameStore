  ...
  return (
    ...
    >
      ...
      <Tooltip title="Home Page">
        <Menu.Item
          key="home"
          icon={<LuJoystick style={iconStyle} className="icon" />}
      ...
      {user?.token && (
        <Tooltip title={user?.full_name}>
          <Menu.Item
            key="user"
            icon={<UserOutlined style={iconStyle} className="icon" />}
            style={{ marginRight: 'auto' }}
          >
      ...
      <Tooltip title="About Page">
        <Menu.Item key="about" style={{ marginRight: '10px' }}>
          <Link to="/about">
            <InfoCircleOutlined style={iconStyle} className="icon" />
          </Link>{' '}
      ...
      <Tooltip title="Contact Page">
        <Menu.Item key="contact" style={{ marginRight: '20px' }}>
          <Link to="/contact">
            <PhoneOutlined style={iconStyle} className="icon" />
          </Link>{' '}
