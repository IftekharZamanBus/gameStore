  ...
  return (
    <div style={containerStyle}>
      ...
      <p style={paragraphStyle}>
        Welcome to our game store. We are passionate about delivering the best
        gaming experience to our customers. Our store offers a wide range of
        games, from classics to the latest releases, ensuring there's something
        for every gaming enthusiast. Our team is dedicated to providing
        exceptional service and helping you find the perfect game. Explore our
        collection and dive into the world of gaming!
      </p>
      ...
      <div style={iconContainerStyle}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={descriptionStyle}>
            Our games provide thrilling entertainment and endless fun for
            players of all ages.
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={descriptionStyle}>
            We offer a diverse selection of games, ensuring there's something
            for every gamer.
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={descriptionStyle}>
            Our store connects gamers worldwide, providing access to games from
            across the globe.
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={descriptionStyle}>
            We foster a welcoming community where gamers can connect, share, and
